...
async function getCurrent() {
    try {
        let response = await fetch('http://springbootback-env.eba-d8bpippp.eu-central-1.elasticbeanstalk.com/rest/current');
...
async function getAllUsers() {
    try {
        let response = await fetch('http://springbootback-env.eba-d8bpippp.eu-central-1.elasticbeanstalk.com/rest/users');
...
async function getAllRoles() {
    try {
        let response = await fetch('http://springbootback-env.eba-d8bpippp.eu-central-1.elasticbeanstalk.com/rest/roles');
...
async function doDelete(trueUserID) {
    try {
        let response = await fetch('http://springbootback-env.eba-d8bpippp.eu-central-1.elasticbeanstalk.com/rest/' + trueUserID, {
            method: 'DELETE',
...
async function doNew() {
    ...
    clearNew();
    try {
        let response = await fetch('http://springbootback-env.eba-d8bpippp.eu-central-1.elasticbeanstalk.com/rest',
            {
                method: 'POST',
